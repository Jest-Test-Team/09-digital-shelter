...
- Inputs: critical user journeys, dependency graph, feature flags, capacity limits, DR plans, incident scenarios
- Outputs: Minimum Viable Service profile, feature shedding order, survival test results, containment boundaries
